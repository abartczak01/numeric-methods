...
# print(exact_len_ellipse(a,b))
# print(a1_riemann(-a, a, n, lambda x: len_ellipse(a, b, x)), "prostokat")
# print(a2_trapezoid(-a, a, n, lambda x: len_ellipse(a, b, x)), "trapez")
# print(a3_simpson(-a, a, n, lambda x: len_ellipse(a, b, x)), "simposn")
# print(a4_spline_interpolation(-a, a, n, lambda x: len_ellipse(a, b, x)), "spline")
...
# print(b_parabola**3/3)
# print(a1_riemann(a_parabola, b_parabola, n, func_parabola), "pros")
# print(a2_trapezoid(a_parabola, b_parabola, n, func_parabola), "trapez")
# print(a3_simpson(a_parabola, b_parabola, n, func_parabola), "simpson")
# print(a4_spline_interpolation(a_parabola, b_parabola, n, func_parabola), "spline")
